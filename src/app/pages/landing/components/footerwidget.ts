...
@Component({
    ...
    template: `
        <footer
            class="mt-16 border-t border-surface-200 dark:border-surface-700 bg-surface-50 dark:bg-surface-950"
        >
            <div
                class="max-w-7xl mx-auto px-6 lg:px-20 py-12"
            >
                <div
                ...
                >
                    ...
                    >
                        <a
                            ...
                            aria-label="Ir al inicio de HealthyMindIA"
                        >
                            <img
                        ...
                        <p
                            class="text-muted-color leading-7 mt-5 mb-0 max-w-sm"
                        >
                            Una plataforma para construir hábitos saludables,
                            analizar tu progreso y recibir recomendaciones
                    ...
                    <div>
                        <h4
                            class="text-surface-900 dark:text-surface-0 font-semibold text-lg mt-0 mb-5"
                        >
                            Plataforma
                        </h4>
                        ...
                        <div class="flex flex-col gap-3">
                            <a
                                ...
                                class="text-muted-color hover:text-primary no-underline transition-colors"
                            >
                                Iniciar sesión
                            </a>
                    ...
                    <div>
                        ...
                        <div class="flex flex-col gap-4">
                            <div
                                class="flex items-center gap-3 text-muted-color"
                            >
                                <i
                                    class="pi pi-heart text-primary"
                                ></i>
                            ...
                            >
                                <i
                                    class="pi pi-sparkles text-primary"
                                ></i>
                ...
                <div
                    class="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 mt-10 border-t border-surface-200 dark:border-surface-700"
                >
                    <p
                        class="text-muted-color text-sm m-0 text-center md:text-left"
                    >
                        © {{ currentYear }} HealthyMindIA. Todos los derechos
                        reservados.
                    </p>
