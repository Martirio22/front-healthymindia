...
@Component({
    ...
    template: `
        ...
        >
            ...
            >
                <div
                    class="flex items-center justify-center rounded-xl bg-primary text-primary-contrast shadow-sm"
                    style="
                        width: 3rem;
                        height: 3rem;
                    "
                >
                    <i
                        class="pi pi-heart-fill text-xl"
                    ></i>
                </div>

                <div class="flex flex-col">
                    <span
                        class="text-surface-900 dark:text-surface-0 font-semibold text-2xl leading-none"
                    >
                        HealthyMindIA
                    </span>

                    <small
                        class="text-muted-color font-normal mt-1"
                    >
