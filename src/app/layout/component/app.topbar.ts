...
@Component({
    ...
    template: `
                ...
                <div class="layout-topbar-menu hidden lg:block">
                    <div class="layout-topbar-menu-content">
                        ...
                        <button
                            ...
                            aria-label="Recomendaciones con IA"
        ...
        >
            <ng-template #start>
                <div
                    class="flex items-center gap-3 px-4 py-4 border-b border-surface-200 dark:border-surface-700"
